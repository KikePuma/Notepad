...
void win() {
	...
	if(!strcmp(temp,"1")) printf("\n\nHa descubierto el código secreto (%s) en %s intento",thread.code,temp);
	else printf("\n\nHa descubierto el código secreto (%s) en %s intentos",thread.code,temp);
	TXT(1,temp);
...
void lose() {
	...
	if(!strcmp(temp,"1")) printf("\n\nNO ha descubierto el código secreto (%s) tras %s intento",thread.code,temp);
	else printf("\n\nNO ha descubierto el código secreto (%s) tras %s intentos",thread.code,temp);
