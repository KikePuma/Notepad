...
int main(int argc, char * argv[]) {
	...
	while(1) {
		...
		switch(option[0]) {
			case '0': printf("\n"); if(isABuffer()) { if(Exit()) return 0;} else { return 1; } break;
